<div class="packages index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions" style="width:170px;">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $package['Package']['id']));  echo $this->Html->image('icons/page.png');?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $package['Package']['id'])); echo $this->Html->image('icons/page_edit.png');?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $package['Package']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $package['Package']['id'])); echo $this->Html->image('icons/page_delete.png'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
