...
<script type="text/javascript">
	tinyMCE.init({
		...
		height:"200",
		skin : "o2k7",
		plugins : "lioniteimages,autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,inlinepopups,autosave",

		// Theme options
		theme_advanced_buttons1 : "save,newdocument,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect,fontselect,fontsizeselect",
		theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,lioniteimages,cleanup,help,code,|,insertdate,inserttime,preview,|,forecolor,backcolor",
			...
			<div id="packages-meta">
               ...
               <tr>
                ...
                <td valign="top" style="margin-top: 5px;">
                                <?php if(isset($packageMeta) and count($packageMeta) >0){?>
                <div><div style="float:left"><label >Package metas</label></div><div id="loader" style="float:right;height:20px;padding-right:30px">&nbsp;</div></div>
                <table class="metaList">
					
				<?php foreach($packageMeta as $key ):	?>
				
					<tr id="metaRow_<?php echo $key['PackageMeta']['id']; ?>">
                      <td><?php echo $key['PackageMeta']['meta_name']; ?></td><td style="width:40px;cursor:pointer"><img src="/img/icons/page_edit.png" alt='Package Edit' id="<?php echo $key['PackageMeta']['id']; ?>" class='editMetaList'/><img src="/img/icons/page_delete.png" alt='Package Delete' id="<?php echo $key['PackageMeta']['id']; ?>" class='deleteMetaList'/></td>
                    </tr>
