...
<?php echo $this->Form->create('Coupon', array('controller'=>'coupons' ,'action' => 'couponCheck/'.$package['Package']['id'],'type' => 'post','id'=>'cupon_check'));?>
  ...
  <tr>
    <td>Package Price</td>
    <td>USD:<span id="package_cost"><?php echo $package['Package']['price']; ?></span></td>
  </tr>
  <tr>
    <td>Additional Person Cost</td>
    <td>USD:<?php echo $package['Package']['additional_person_cost']; ?></td>
  </tr>
  <tr>
...
<table width="100%" class="tblorder">
  ...
  <tr><td>
      ...
      <tr>
        <td>Package Price</td>
        <td>USD:<?php echo $package['Package']['price']?></td>
      </tr>
      <tr>
        <td>Additional Persons Cost</td>
        <td>USD:<?php  echo $purchase['Package']['additional_person_cost']?></td>
      </tr>
      <tr>
	...
	<table width="100%" border="1" class="tblorder">
      ...
      <tr>
		...
		foreach ($added_service as $key=>$service){ ?>
			<span style="display: block;"><?php echo $service['Vas']['name'];?> USD:<?php echo $service['Vas']['price'];?></span>
		<?php }?></td>
      </tr>
       
      <tr>
        <td>Total of Value added service price</td>
        <td>USD:<?php echo $sum_vas; ?> </td>
      </tr>
      <?php } ?>
      <tr>
        <td>Package Price</td>
      ...
      <tr>
        ...
        <td><?php 
         ...
         if(@$this->params['pass'][1] == 1){
					//debug($bookagain);
					echo  $bookagain['Purchase']['additional_persons'];
				}
		 else{
			 	echo $purchase['Purchase']['additional_persons'];
					}
        ?>
        </td>
      </tr>
