...
<h2><?php  __('Package');?></h2>
  ...
  <tr>
    ...
    <td><?php echo $this->Html->link($package['Location']['name'], array('controller' => 'locations', 'action' => 'view', $package['Location']['id'])); ?></td>
  </tr>
  <tr>
    <td><?php __('Price'); ?></td>
  ...
  <tr>
    <td><?php __('Hotel'); ?></td>
    <td><?php echo $this->Html->link($package['Hotel']['name'], array('controller' => 'hotels', 'action' => 'view', $package['Hotel']['id'])); ?></td>
  </tr>
  <tr>
    <td><?php __('Room Type'); ?></td>
    <td><?php echo $this->Html->link($package['RoomType']['name'], array('controller' => 'room_types', 'action' => 'view', $package['RoomType']['id'])); ?></td>
  </tr>
  <tr>
    <td><?php __('Meal Plan'); ?></td>
    <td><?php echo $this->Html->link($package['MealPlan']['name'], array('controller' => 'meal_plans', 'action' => 'view', $package['MealPlan']['id'])); ?></td>
  </tr>
  <tr>
    <td><?php __('Max People'); ?></td>
    <td><?php echo $package['Package']['max_people']; ?></td>
  </tr>
  <tr>
    <td><?php __('Additional Person Cost'); ?></td>
  ...
  <tr>
    <td><?php __('Main Image'); ?></td>
    <td><?php 
   echo $this->Image->resize('' . $package['Package']['default_map'], 100, 200);
    ?></td>
  </tr>
  <tr>
    <td><?php __('Default Video'); ?></td>
