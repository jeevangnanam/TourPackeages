...
<div class="main">
        ...
        <header>
        	<div class="header-padding">
                               <div id='dashboard'>you are logging as <?php echo $this->Session->Read('Auth.User.name');  ?>  &nbsp;<?php echo  $this->Html->link('My account:', array('controller'=>'payments','action' => 'view')); ?>  </div>
                            	<div style="float:right; margin-top:-40px;"><?php echo $facebook->login(array('perms' => 'email,publish_stream')); ?></div>
                <div class="main">
