<div id="nav">
    <ul class="sf-menu">
    	<li>
        	 <?php //echo $this->Html->link(__('All', true), array('plugin' => null, 'controller' => '', 'action' => '')); ?>
             <a href="#">All</a>
             <ul>
             	<li>
...
<!--zczf-->
        ...
        <!-- my added menus -->
        <li>
            <?php echo $this->Html->link(__('Hotels', true), array('plugin' => null, 'controller' => 'hotels', 'action' => 'index')); ?>
            <ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'hotels', 'action' => 'add')); ?></li>
                
            </ul>
        </li>
        
        <li>
            <?php echo $this->Html->link(__('Packages', true), array('plugin' => null, 'controller' => 'packages', 'action' => 'index')); ?>
            <ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'packages', 'action' => 'add')); ?></li>
                <li><?php echo $this->Html->link(__('Package Catagories', true), array('plugin' => null, 'controller' => 'package_categories', 'action' => 'index')); ?>
                	<ul>
                		<li><?php echo $this->Html->link(__('Add Catagories', true), array('plugin' => null, 'controller' => 'package_categories', 'action' => 'add')); ?></li>
                	</ul>
                </li>
                <li>
                	<?php echo $this->Html->link(__('Coupons', true), array('plugin' => null, 'controller' => 'coupons', 'action' => 'index')); ?>
                	<ul>
                		<li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'coupons', 'action' => 'add')); ?></li>
                	</ul>
            	</li>
            </ul>
        ...
        <li>
            <?php echo $this->Html->link(__('Room Types', true), array('plugin' => null, 'controller' => 'room_types', 'action' => 'index')); ?>
            <ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'room_types', 'action' => 'add')); ?></li>
            </ul>
        </li>
        
        <li>
            <?php echo $this->Html->link(__('Meal Plans', true), array('plugin' => null, 'controller' => 'meal_plans', 'action' => 'index')); ?>
            <ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'meal_plans', 'action' => 'add')); ?></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'locations', 'action' => 'add')); ?></li>
            </ul>
        </li>
        
        <li>
            <?php echo $this->Html->link(__('Vas', true), array('plugin' => null, 'controller' => 'vas', 'action' => 'index')); ?>
            <ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'vas', 'action' => 'add')); ?></li>
            </ul>
        </li>
        <li>
            <?php echo $this->Html->link(__('Purchases', true), array('plugin' => null, 'controller' => 'purchases', 'action' => 'index')); ?>
            <!--<ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'vas', 'action' => 'add')); ?></li>
            </ul>-->
        </li>    
        <li>
            <?php echo $this->Html->link(__('Payments', true), array('plugin' => null, 'controller' => 'payments', 'action' => 'index')); ?>
            <!--<ul>
                <li><?php echo $this->Html->link(__('Add', true), array('plugin' => null, 'controller' => 'vas', 'action' => 'add')); ?></li>
            </ul>-->
        </li>
        ...
        <!--<li>
            <a href="#">Other</a>
            <ul>
                <li><?php echo $this->Html->link(__('Coupons', true), array('plugin' => null, 'controller' => 'coupons', 'action' => 'index')); ?></li>
            </ul>
        </li>
    --></ul>
</div>