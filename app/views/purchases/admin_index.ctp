<div class="purchases index">
	<h2><?php __('Purchases');?></h2>
     <?php
 		echo $form->create('Purchase',array('url'=>'/admin/purchases/export/')); 
 		//echo $this->Form->input('month' , array('type' => 'select', 'options' => array('jan' => 'jan', 'feb' => 'feb', 'march' => 'march'), 'empty' => 'SELECT'));
 		echo $this->Form->month('mob', null, array('monthNames' => true, 'empty' => 'SELECT'));
 		?>
 <?php echo $this->Form->end(__('Export CSV', true));?>
 <br/>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('coupon_id_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'viewInvoice', $purchase['Purchase']['id']));echo $this->Html->image('icons/money.png'); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $purchase['Purchase']['id']));echo $this->Html->image('icons/money_add.png'); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $purchase['Purchase']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $purchase['Purchase']['id']));echo $this->Html->image('icons/money_delete.png'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
