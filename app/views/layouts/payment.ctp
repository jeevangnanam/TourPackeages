...
<div class="main">
        ...
        <header>
        <div id='dashboard'>You are logging as <?php echo $this->Session->Read('Auth.User.name');  echo ' <span>|</span> '; echo  $this->Html->link('My account:', array('controller'=>'payments','action' => 'view')); ?>  </div>
