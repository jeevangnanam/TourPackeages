...
class SitemapsController extends AppController{ 
    ...
    var $uses = array('Package','Hotel','Location'); 
     ...
     */ 
    function __get_data() { 
        ClassRegistry::init('Package')->recursive = false; 
        $this->__add_dynamic_section( 
                             'Package',  
                             ClassRegistry::init('Package')->find('all', array('fields' => array('name', 'short_description'))),  
                             array( 
                                    'controllertitle' => 'Packages', 
                                    'fields' => array('id' => 'slug'), 
                                    'changefreq' => 'daily', 
                                    'pr' => '1.0',  
                                    'url' => array('controller' => 'packages', 'action' => 'view') 
                                   ) 
                             );         
        ...
        ClassRegistry::init('Hotel')->recursive = false; 
        $this->__add_dynamic_section( 
                             'Hotel',  
                             ClassRegistry::init('Hotel')->find('all', array('fields' => array('id', 'name'))),  
                             array( 
                                    'controllertitle' => 'Hotels', 
                                    'fields' => array('title' => 'name', 'date' => false), 
                                    'pr' => '0.7',  
                                    'changefreq' => 'weekly', 
                                    'url' => array('controller' => 'hotels', 'action'=>'view') 
                                   ) 
                             ); 
    } 
